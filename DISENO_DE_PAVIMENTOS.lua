...
--ddCat(1, "Resistive Circuits", "Performs routine calculations of resistive circuits")
...
--
--addSubCat(16, 1, "Calculo de ESAL", "") 
...
--addSubCat(16, 13, "Calculo De ESAL") 
...
function manualSolver:pushed(cid, sid)
    ...
    manualSolver.sb:update(0, math.floor(self.pl.h / 30 + .5), i+12)
    self.pl:giveFocus()
