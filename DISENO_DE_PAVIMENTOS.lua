...
---Test
addCat(17, "Diseño de Pavimento", "Diseño de pavimentos según AASHTO 93-MTC") 

addCatVar(17, "ESAL", "Esal x dia", "unitless")
addCatVar(17, "TC", "Tasa crecimiento %", "unitless")
addCatVar(17, "PD", "Periodo de diseño", "unitless")
...
addCatVar(17, "CBR_SR", "CBR Sub Rasante", "unitless")
addCatVar(17, "FCA", "Factor Carril", "unitless")
addCatVar(17, "CEE", "Carga de Ejes Equivalentes", "unitless")
addCatVar(17, "MR", "Modulo de Resilencia", "unitless")

addSubCat(17, 1, "Flexible", "") 
aF(17, 1, "FCA=(((1+(TC*0.01))^PD)-1)/(TC*0.01)", U("FCA","TC","PD"))
--aF(17, 1, "FCA=(((1+(TC*0.01))^PD)-1)/(TC*0.01)", U("FCA","ESAL","TC","PD","CA","EM","CBR_B","CBR_SB","CBR_SR"))
aF(17, 1, "CEE=FCA*ESAL*365", U("FCA","CEE","ESAL"))
aF(17, 1, "MR=2555*(CBR_SR)^0.64", U("MR","CBR_SR"))

addSubCat(17, 2, "Rigido", "")
